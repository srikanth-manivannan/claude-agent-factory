...
**Category:** leadership · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to draft clear status and decision communications for stakeholders._

## Quickstart
```text
1. Copy skills/leadership/stakeholder-comms-writer/ into your project's skills directory.

...
> Use this to produce constructive, standards-based code reviews.
...
achieve this without rebuilding it each time: _Use this to produce constructive, standards-based code reviews._

## Quickstart
```text
1. Copy skills/leadership/code-review-coach/ into your project's skills directory.

...
**Category:** backend · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to scaffold a REST endpoint with validation, error handling, and tests._

## Quickstart
```text
1. Copy skills/backend/rest-endpoint-scaffold/ into your project's skills directory.

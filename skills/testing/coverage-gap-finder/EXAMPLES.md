...
**Result:** a reviewable output that fulfils _Use this to find and fill meaningful test-coverage gaps._

## Anti-example
- ❌ Using this skill outside its stated scope — use the appropriate skill in the
  [testing category](../) instead.

...
> Use this to find and fill meaningful test-coverage gaps.

**Category:** testing · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to find and fill meaningful test-coverage gaps._

## Quickstart
```text
1. Copy skills/testing/coverage-gap-finder/ into your project's skills directory.

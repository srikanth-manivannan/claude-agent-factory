...
> Use this to improve flaky, slow, or brittle tests.
...
achieve this without rebuilding it each time: _Use this to improve flaky, slow, or brittle tests._

## Quickstart
```text
1. Copy skills/testing/test-refactorer/ into your project's skills directory.

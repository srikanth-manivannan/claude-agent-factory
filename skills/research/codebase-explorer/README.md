...
**Category:** research · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to map an unfamiliar codebase and summarize how it works._

## Quickstart
```text
1. Copy skills/research/codebase-explorer/ into your project's skills directory.

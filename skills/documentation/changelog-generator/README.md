...
achieve this without rebuilding it each time: _Use this to generate a Keep a Changelog entry from a set of changes._

## Quickstart
```text
1. Copy skills/documentation/changelog-generator/ into your project's skills directory.

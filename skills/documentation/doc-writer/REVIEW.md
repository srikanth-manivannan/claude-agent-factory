...
- **documentation-review:** README complete; one-sentence description; examples/troubleshooting/
  resources; CHANGELOG — **pass**.
- **testing-review:** happy/edge/failure/refusal + compliance cases — **pass**.

## Known minor follow-ups (🟡)
- `doc-linter` / `api-reference-generator` cross-links are to planned skills (declared-pending).

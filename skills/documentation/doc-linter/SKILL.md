---
name: doc-linter
description: Use this to check documentation for completeness and freshness.
version: 0.1.0
...
> Use this to check documentation for completeness and freshness.
...
- When you need to: use this to check documentation for completeness and freshness.
...
## Instructions
1. Confirm the goal — _Use this to check documentation for completeness and freshness._ — and gather the inputs above.
...
## Output
A clear, reviewable result that fulfils the skill's purpose: _Use this to check documentation for completeness and freshness._

...
**Category:** documentation · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to check documentation for completeness and freshness._

## Quickstart
```text
1. Copy skills/documentation/doc-linter/ into your project's skills directory.

# Examples — Client Perf Optimizer
...
**Result:** a reviewable output that fulfils _Use this to diagnose and fix client-side bundle and rendering performance._

## Anti-example
- ❌ Using this skill outside its stated scope — use the appropriate skill in the
  [frontend category](../) instead.

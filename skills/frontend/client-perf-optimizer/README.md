# Client Perf Optimizer

> Use this to diagnose and fix client-side bundle and rendering performance.

**Category:** frontend · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to diagnose and fix client-side bundle and rendering performance._

## Quickstart
```text
1. Copy skills/frontend/client-perf-optimizer/ into your project's skills directory.

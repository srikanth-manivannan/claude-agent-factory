...
achieve this without rebuilding it each time: _Use this to audit dependencies for known vulnerabilities and a remediation path._

## Quickstart
```text
1. Copy skills/security/dependency-vuln-auditor/ into your project's skills directory.

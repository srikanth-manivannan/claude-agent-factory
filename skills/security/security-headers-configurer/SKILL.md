---
name: security-headers-configurer
description: Use this to configure security headers and TLS correctly.
version: 0.1.0
category: security
runtime: claude
min_standard: 0.1.0
...
# Security Headers Configurer

> Use this to configure security headers and TLS correctly.
...
- When you need to: use this to configure security headers and tls correctly.
...
## Instructions
1. Confirm the goal — _Use this to configure security headers and TLS correctly._ — and gather the inputs above.
...
## Output
A clear, reviewable result that fulfils the skill's purpose: _Use this to configure security headers and TLS correctly._

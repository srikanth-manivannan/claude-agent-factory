...
achieve this without rebuilding it each time: _Use this to configure security headers and TLS correctly._

## Quickstart
```text
1. Copy skills/security/security-headers-configurer/ into your project's skills directory.

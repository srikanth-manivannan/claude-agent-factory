---
name: threat-modeler
description: Use this to run a STRIDE threat model on a system design.
version: 0.1.0
category: security
runtime: claude
min_standard: 0.1.0
...
- When you need to: use this to run a stride threat model on a system design.
...
## Instructions
1. Confirm the goal — _Use this to run a STRIDE threat model on a system design._ — and gather the inputs above.
...
## Output
A clear, reviewable result that fulfils the skill's purpose: _Use this to run a STRIDE threat model on a system design._

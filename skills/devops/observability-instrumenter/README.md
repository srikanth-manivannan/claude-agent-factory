...
achieve this without rebuilding it each time: _Use this to add logs, metrics, and traces to a service._

## Quickstart
```text
1. Copy skills/devops/observability-instrumenter/ into your project's skills directory.

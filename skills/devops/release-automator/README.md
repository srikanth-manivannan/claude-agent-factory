...
> Use this to automate semantic-version releases with changelog and tagging.

**Category:** devops · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to automate semantic-version releases with changelog and tagging._

## Quickstart
```text
1. Copy skills/devops/release-automator/ into your project's skills directory.

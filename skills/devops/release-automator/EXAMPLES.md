...
**Result:** a reviewable output that fulfils _Use this to automate semantic-version releases with changelog and tagging._

## Anti-example
- ❌ Using this skill outside its stated scope — use the appropriate skill in the
  [devops category](../) instead.

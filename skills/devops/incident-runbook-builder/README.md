...
achieve this without rebuilding it each time: _Use this to produce an incident-response runbook for a service._

## Quickstart
```text
1. Copy skills/devops/incident-runbook-builder/ into your project's skills directory.

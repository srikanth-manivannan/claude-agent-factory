...
description: Use this to produce an incident-response runbook for a service.
version: 0.1.0
category: devops
runtime: claude
min_standard: 0.1.0
...
> Use this to produce an incident-response runbook for a service.
...
- When you need to: use this to produce an incident-response runbook for a service.
...
## Instructions
1. Confirm the goal — _Use this to produce an incident-response runbook for a service._ — and gather the inputs above.
...
## Output
A clear, reviewable result that fulfils the skill's purpose: _Use this to produce an incident-response runbook for a service._

...
achieve this without rebuilding it each time: _Use this to diagnose and optimize slow database queries._

## Quickstart
```text
1. Copy skills/database/query-optimizer/ into your project's skills directory.

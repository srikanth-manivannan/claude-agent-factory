...
description: Use this to diagnose and optimize slow database queries.
version: 0.1.0
category: database
runtime: claude
min_standard: 0.1.0
...
> Use this to diagnose and optimize slow database queries.
...
- When you need to: use this to diagnose and optimize slow database queries.
...
## Instructions
1. Confirm the goal — _Use this to diagnose and optimize slow database queries._ — and gather the inputs above.
...
## Output
A clear, reviewable result that fulfils the skill's purpose: _Use this to diagnose and optimize slow database queries._

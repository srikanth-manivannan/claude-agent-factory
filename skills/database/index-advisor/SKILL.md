---
name: index-advisor
description: Use this to recommend and validate database indexes for given query patterns.
version: 0.1.0
category: database
runtime: claude
min_standard: 0.1.0
...
> Use this to recommend and validate database indexes for given query patterns.
...
- When you need to: use this to recommend and validate database indexes for given query patterns.
...
## Instructions
1. Confirm the goal — _Use this to recommend and validate database indexes for given query patterns._ — and gather the inputs above.
...
## Output
A clear, reviewable result that fulfils the skill's purpose: _Use this to recommend and validate database indexes for given query patterns._

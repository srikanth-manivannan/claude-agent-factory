...
**Result:** a reviewable output that fulfils _Use this to write safe, reversible database migrations from a schema change._

## Anti-example
- ❌ Using this skill outside its stated scope — use the appropriate skill in the
  [database category](../) instead.

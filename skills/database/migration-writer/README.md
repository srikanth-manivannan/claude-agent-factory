...
achieve this without rebuilding it each time: _Use this to write safe, reversible database migrations from a schema change._

## Quickstart
```text
1. Copy skills/database/migration-writer/ into your project's skills directory.

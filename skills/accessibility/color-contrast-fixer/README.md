...
achieve this without rebuilding it each time: _Use this to detect and fix color-contrast failures to meet WCAG AA._

## Quickstart
```text
1. Copy skills/accessibility/color-contrast-fixer/ into your project's skills directory.

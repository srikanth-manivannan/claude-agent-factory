...
**Result:** a reviewable output that fulfils _Use this to detect and fix color-contrast failures to meet WCAG AA._

## Anti-example
- ❌ Using this skill outside its stated scope — use the appropriate skill in the
  [accessibility category](../) instead.

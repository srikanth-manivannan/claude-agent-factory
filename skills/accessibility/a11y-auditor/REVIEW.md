...
- Applicable checklists: **Universal Core** + **accessibility-review** +
...
- **accessibility-review:** AA default; findings cite element + criterion; manual limits
  flagged; semantic-first guidance — **pass**.
- **documentation-review / testing-review:** complete docs; happy/edge/refusal/honesty cases — **pass**.

## Known minor follow-ups (🟡)
- Fixer skills (`aria-annotator`, `color-contrast-fixer`, `keyboard-nav-checker`) are
  planned (declared-pending cross-links).

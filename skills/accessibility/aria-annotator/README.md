...
> Use this to add correct ARIA roles and labels to markup to close accessibility gaps.

**Category:** accessibility · **Version:** 0.1.0 · **Runtime:** claude · **License:** MIT · **Maturity:** baseline
...
achieve this without rebuilding it each time: _Use this to add correct ARIA roles and labels to markup to close accessibility gaps._

## Quickstart
```text
1. Copy skills/accessibility/aria-annotator/ into your project's skills directory.

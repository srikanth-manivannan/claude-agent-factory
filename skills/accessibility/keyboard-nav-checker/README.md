...
> Use this to verify and fix keyboard operability and focus order.
...
achieve this without rebuilding it each time: _Use this to verify and fix keyboard operability and focus order._

## Quickstart
```text
1. Copy skills/accessibility/keyboard-nav-checker/ into your project's skills directory.
